					...
					<ul class="navbar-nav ml-auto text-success text-monospace">
						...
						<li class="nav-item active">
							<a class="nav-link text-success" href="#"><i
									class="fas fa-calendar-check fa-fw pr-2"></i>Events</a>
						</li>
						<li class="nav-item active">
							<a class="nav-link text-success" href="#"><i class="fas fa-user-circle fa-fw pr-2"></i>Profile</a>
						</li>
						<li class="nav-item active">
							<a class="nav-link text-success" href="#"><i class="fas fa-sign-out-alt fa-fw pr-2"></i>Sign
								Out</a>
						</li>
					</ul>
				</div>
			...
			<div class="card text-success bg-dark col-lg-4 col-md-6 col-sm-10 m-2">
				...
				<div class="card-body">
					...
					<p class="card-text">Find fellow book worms to discuss plot holes, inconsistencies, and talk about the
						next part of your favorite series.</p>
